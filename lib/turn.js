...
; (function ($, window, document, undefined) {
    ...
    var has3d,
>>>>>>> bb63e97d8a0a7266758e5304fce364be620fafd4
        hasRot,
        vendor = "",
        version = "4.1.2",
        PI = Math.PI,
...
<<<<<<< HEAD
        ...
        turnMethods = {
            ...
            init: function (options) {
                ...
                var i, that = this,
                    wrapper = this.wrap('<div class="turn-container">').parent(),
                    pageNum = 0,
                    data = this.data(),
                    ch = this.children();
                ...
                for (i = 0; i < ch.length; i++) {
                    if ($(ch[i])
                        .attr('ignore') != '1') {
                        this.turn('addPage', ++pageNum, ch[i]);
                    }
                }
                ...
                $(window)
                    .on("resize", turnMethods.resizeViewport.bind(that));

                turnMethods.resizeViewport.call(that);
            ...
            addPage: function (page, element) {
                ...
                if (page) {
                    if (page == lastPage)
                        ...
                        throw new Error('TurnJS: page "' + page + '" could not be inserted.');
                ...
                if (page >= 1 && page <= lastPage) {
                    ...
                    data.pageObjs[page] = $(element).addClass('page page-' + page + parity).data('page', page).html('<div class="gradient"/><div class="loader"/>');
            ...
            _addPage: function (page) {
                ...
                var data = this.data(),
                    element = data.pageObjs[page] || false;
            ...
            loadPage: function (page, pageElement) {
                ...
                $('<img>')
                    ...
                    .on('load', function () {
                        ...
                        $(pageElement).append(this);

                        // Remove the loader indicator
                        pageElement.find('.loader').remove();
                    })
                    // starts to load
                    .attr("src", this.data().opts.sourceFolder + (page + 1000) + ".jpg");
            ...
            _movePages: function (from, change) {
                ...
                var page,
                    ...
                    move = function (page) {
                        ...
                        if (data.pageObjs[page])
                            data.pageObjs[next] = data.pageObjs[page].removeClass('page-' + page + ' odd even')
                            .addClass('page-' + next + parity);
                        ...
                        if (data.pagePlace[page] && data.pageWrap[page]) {
                            ...
                            if (data.pageObjs[next].hasClass('fixed'))
                                ...
                                data.pageWrap[next] = data.pageWrap[page].css(turnMethods._pageSize.call(that, next, true))
                                .data('page', next);
            ...
            _turnPage: function (page) {
                ...
                var optsCorners = data.opts.turnCorners.split(','),
                    flipData = data.pages[current].data()
                    .f,
                    opts = flipData.opts,
            ...
            resizeViewport: function () {
                    ...
                    if ($('.magazine').turn('zoom') == 1) {
                        ...
                        $('.magazine').turn('size', Math.floor(bound.width * 0.9), Math.floor(bound.height * 0.9));
        ...
        flipMethods = {
            ...
            _addPageWrapper: function () {
                ...
                if (!data.wrapper)
                    ...
                    case 'sheet':
                        ...
                        data.fparent = data.opts.turn.data()
                            .fparent;
                ...
                if (move) {
                    ...
                    if (data.folding) {
                        ...
                        if (turnData.pages[data.folding]) {
                            ...
                            var flipData = turnData.pages[data.folding].data()
                                .f;
            ...
            _eventStart: function (e) {
                ...
                if (!data.corner && !data.disabled && !this.flip('isTurning') &&
                    data.opts.page == turn.data()
                    .pagePlace[data.opts.page]) {
...
=======
        ...
        flipMethods = {
            ...
            _backGradient: function () {
                ...
                if (gradient && !data.bshadow) {
                    data.bshadow = $('<div/>', divStyle(0, 0, 1)).css({
                        position: '',
                        width: this.width(),
                        height: this.height()
                    }).appendTo(data.parent);
                    ...
                    switch (data.effect) {
                        ...
                        case 'sheet':
                            ...
                            if (!data.fparent) {
                                ...
                                fparent.css(divStyle(0, 0, 'auto', 'visible').css).appendTo(data.opts.turn);
                            ...
                            data.fwrapper = $('<div/>', divStyle(parent.offset().top, parent.offset().left))
                                .hide()
                                .appendTo(data.fparent);

                            data.fpage = $('<div/>', divStyle(0, 0, 0, 'visible')).css({
                                cursor: 'default'
                            }).appendTo(data.fwrapper);

                            if (turnData.opts.gradients)
                                data.ashadow = $('<div/>', divStyle(0, 0, 1)).appendTo(data.fpage);
            ...
            peel: function (corner, animate) {
                ...
                if (corner) {
                    ...
                    if ($.inArray(corner, corners.all) == -1)
                        console.error('Corner ' + corner + ' is not permitted');
    ...
    $.extend($.fn, {
        ...
        flip: function (options) {
            ...
            else if (methods[options] !== undefined)
                return methods[options].apply(this, Array.prototype.slice.call(args, 1)); // Array.prototype.slice will convert the arguments object
            return false;
        },
    ...
    $.extend(Plugin.prototype, {
        ...
        init: function (options) {
            ...
            var i,
                wrapper = this.$el.wrap('<div class="turn-container">').parent(),
                pageNum = 0,
                ch = this.$el.children();
            ...
            this.dataset.opts = options;
            this.dataset.pageObjs = {};
            this.dataset.pages = {};
            this.dataset.pageWrap = {};
            this.dataset.pageZoom = {};
            this.dataset.pagePlace = {};
            this.dataset.pageMv = [];
            this.dataset.zoom = 1;
            this.dataset.totalPages = options.pages || 0;
            this.dataset.eventHandlers = {
                touchStart: $.proxy(this._touchStart, this),
                touchMove: $.proxy(this._touchMove, this),
                touchEnd: $.proxy(this._touchEnd, this),
                start: $.proxy(this._eventStart, this)
            };
            ...
            if (options.when) {
                for (i in options.when) {
                    if (hasOwnProperty(i, options.when)) {
                        this.$el.on(i, options.when[i]);
                    }
                }
            }
            ...
            if (has3d && !isTouch && options.acceleration)
                this.$el.transform(translate(0, 0, true));
            ...
            // Event listeners
            this.$el
                .on(triggers.down, this.dataset.eventHandlers.touchStart)
                .on('end', this._eventEnd)
                .on('pressed', this._eventPressed)
                .on('released', this._eventReleased)
                .on('flip', this._flip);

            wrapper
                .on('start', this.dataset.eventHandlers.start);

            $(document)
                .on(triggers.move, this.dataset.eventHandlers.touchMove)
                .on(triggers.up, this.dataset.eventHandlers.touchEnd);

            $(window)
                .on('resize', this._resizeViewport);
            ...
            // This flipbook is ready
            // data.done = true;
            this.$el.trigger('initialized.' + this.name);
        ...
        addPage: function (element, page) {
            ...
            var currentPage,
                parity,
                incPages = false,
                lastPage = this.dataset.totalPages + 1;

            if (data.destroying)
                return false;

            // Read the page number from the className of `element` - format: page\-[0-9]+
            if ((currentPage = /\bpage\-([0-9]+)\b/.exec($(element).attr('class'))))
            ...
            if (page) {
                ...
                if (page == lastPage)
                    ...
                    console.error('Page "' + page + '" cannot be inserted.');
            ...
            if (page >= 1 && page <= lastPage) {
                ...
                if (this.dataset.display == 'double')
                    parity = (page % 2) ? ' odd' : ' even';
                else
                    parity = '';
                ...
                // Move pages if it's necessary
                if (page in this.dataset.pageObjs)
                    this._movePages.call(this, page, 1);

                // Increase the number of pages
                if (incPages)
                    this.dataset.totalPages = lastPage;

                // Add element
                this.dataset.pageObjs[page] = $(element).addClass('page page-' + page + parity);

                // Checks if there's hard page compatibility
                // IE9 is the only browser that does not support hard pages
                if (!(navigator.userAgent.indexOf('MSIE 9.0') == -1) && this.dataset.pageObjs[page].hasClass('hard')) {
                    this.dataset.pageObjs[page].removeClass('hard');
                }
        ...
        _addPage: function (page) {
            ...
            var element = this.dataset.pageObjs[page];

            if (element)
                if (this._necessPage(page)) {

                    if (!this.dataset.pageWrap[page]) {
                        ...
                        // Wrapper
                        this.dataset.pageWrap[page] = $('<div/>', {
                            class: 'page-wrapper' + parity,
                            page: page,
                            data: {
                                page: page
                            }
                        ...
                        // Append to this flipbook
                        this.append(this.dataset.pageWrap[page]);

                        if (!this.dataset.pagePlace[page]) {

                            this.dataset.pagePlace[page] = page;
                            // Move `pageObjs[page]` to wrapper
                            this.dataset.pageObjs[page].appendTo(this.dataset.pageWrap[page]);

                        }

                        // Set the size of the page
                        /*var prop = this._pageSize.call(this, page, true);
                        element.css({
                            width: prop.width,
                            height: prop.height
                        });
                    ...
                    if (this.dataset.pagePlace[page] == page) {
                    ...
                    // Place
                    this.dataset.pagePlace[page] = 0;

                    // Remove element from the DOM
                    if (this.dataset.pageObjs[page])
                        this.dataset.pageObjs[page].remove();
        ...
        hasPage: function (page) {
            return hasOwnProperty(page, this.$el.data().pageObjs);
        },
        ...
        zoom: function (newZoom) {
            ...
            if (typeof (newZoom) == 'number') {
                ...
                if (newZoom < 0.001 || newZoom > 100)
                    console.error(newZoom + ' is not a value for zoom');
        ...
        range: function (page) {
            ...
            page = page || data.tpage || data.page || 1;
            view = this._view(page);

            if (page < 1 || page > data.totalPages)
                console.error('"' + page + '" is not a valid page');
        ...
        _removeFromDOM: function () {
            ...
            var page, data = this.$el.data();

            for (page in data.pageWrap)
                if (hasOwnProperty(page, data.pageWrap) &&
                    !this._necessPage(page))
        ...
        removePage: function (page) {
            ...
            if (page == '*') {
                ...
                if (page < 1 || page > data.totalPages)
                    console.error('The page ' + page + ' doesn\'t exist');
                ...
                move = function (page) {
                    ...
                    if (data.pagePlace[page] && data.pageWrap[page]) {
                        ...
                        if (data.pageObjs[next].hasClass('fixed'))
                            ...
                            data.pageWrap[next] = data.pageWrap[page].css(this._pageSize.call(this.$el, next, true)).data('page', next);
        ...
        display: function (display) {
            ...
            if (display === undefined) {
                ...
                if ($.inArray(display, displays) == -1)
                    console.error('"' + display + '" is not a value for display');
        ...
        direction: function (dir) {
            ...
            if (dir === undefined) {
                ...
                if ($.inArray(dir, directions) == -1)
                    console.error('"' + dir + '" is not a value for direction');
        ...
        corner: function () {
            ...
            for (page in data.pages) {
                if (hasOwnProperty(page, data.pages))
                    if ((corner = data.pages[page].flip('corner'))) {
                        return corner;
                    }
            }
        ...
        size: function (width, height) {
            ...
            if (width === undefined || height === undefined) {
                ...
                for (page in data.pageWrap) {
                    if (!hasOwnProperty(page, data.pageWrap)) continue;

                    prop = this._pageSize(page, true);
            ...
            if (page === undefined) {
                ...
                if (!data.disabled && !data.destroying) {
                    ...
                    if (page > 0 && page <= data.totalPages) {
                        ...
                        console.error('The page ' + page + ' does not exist');
        ...
        next: function () {
            ...
            return this.turn('page', Math.min(this.data().totalPages, this._view(this.data().page).pop() + 1));
        ...
        previous: function () {
            ...
            return this.turn('page', Math.max(1, this._view(this.data().page).shift() - 1));
        ...
        _addMotionPage: function () {
            ...
            this._addMv.call(turn, opts.page);
        ...
        _eventStart: function (e, opts, corner) {
            ...
            if (e.isDefaultPrevented()) {
                this._updateShadow.call(opts.turn);
                return;
            }
            ...
            this._addMotionPage.call(e.target);
            this._updateShadow.call(opts.turn);
        },
        ...
        _eventEnd: function (e, opts, turned) {
            ...
            if (turned) {
                ...
                if (tpage == opts.next || tpage == opts.page) {
                    ...
                    this._fitPage.call(turn, tpage || opts.next, true);
                }

            } else {

                this._removeMv.call(turn, opts.page);
                this._updateShadow.call(turn);
                turn.turn('update');
        ...
        _eventReleased: function (e, point) {
            ...
            if ((new Date()).getTime() - data.time < 200 || outArea) {
                ...
                e.preventDefault();
                this._turnPage.call(turn, data.opts.next);
        ...
        update: function () {
            ...
            if (this.turn('animating') && data.pageMv[0] !== 0) {
                ...
                for (page in data.pageWrap) {
                    ...
                    var pageLocation = this._setPageLoc(page);
        ...
        options: function (options) {
            ...
            if (options === undefined) {
                ...
                if (options.when)
                    for (var eventName in options.when)
                        if (hasOwnProperty(eventName, options.when)) {
        ...
        _resizeViewport: function () {
            ...
            this.$el.parent().zoom('resize');

            if (this.dataset.zoom == 1) {
                var bound = calculateBound({
                    width: this.dataset.width,
                    height: this.dataset.height,
                    boundWidth: Math.min(this.dataset.width, windowWidth),
                    boundHeight: Math.min(this.dataset.height, windowHeight)
                });

                if (bound.width % 2 !== 0) bound.width -= 1;

                if (bound.width != this.width() || bound.height != this.height()) {
                    this.turn('size', wrapper.width() * 0.9, bound.height * 0.9);
                }
            }
    ...
    $.fn[pluginName] = function (options) {
        if (options === undefined || typeof options === 'object') {
            ...
            return $.data(this, 'plugin_' + pluginName) instanceof Plugin;
            ...
            return this.each(function () {
                ...
                if (instance instanceof Plugin && typeof instance[options] === 'function') {
                    var args = arguments;
                    instance[options].apply(instance, Array.prototype.slice.call(args, 1)); // Array.prototype.slice will convert the arguments object to array passed by .call()
                }
            });
        }
    };
