    ...
    $.extend(Plugin.prototype, {
        ...
        init: function (options) {
            ...
            this.dataset.eventHandlers = {
                touchStart: $.proxy(this._touchStart, this.$el),
                touchMove: $.proxy(this._touchMove, this.$el),
                touchEnd: $.proxy(this._touchEnd, this.$el),
                start: $.proxy(this._eventStart, this.$el)
            };
            ...
            wrapper
                .on('start', data.eventHandlers.start);
