    ...
    var $ = jQuery,
        ...
        turnMethods = {
            ...
            init: function(options) {
                ...
                // Event listeners
                $(this)
                    .on(triggers.down, data.eventHandlers.touchStart)
                ...
                $(window)
                    .on("resize", turnMethods._resizeViewport.bind(this));
            ...
            addPage: function(element, page) {
                ...
                if (page >= 1 && page <= lastPage) {
                    ...
                    // Add element
                    data.pageObjs[page] = $(element).addClass('page page-' + page + parity);
            ...
            destroy: function() {
                ...
                this.parent()
                    .off('start', data.eventHandlers.start);
            ...
            _removePageFromDOM: function(page) {
                ...
                if (data.pages[page]) {
                    ...
                    turnMethods._moveFoldingPage.call(data.pages[page], false);
            ...
            stop: function(ignore, animate) {
                ...
                if (this.turn('animating')) {
                    ...
                    for (i = 0; i < data.pageMv.length; i++) {
                        ...
                        if (!animate)
                            turnMethods._moveFoldingPage.call(page, false);
            ...
            _touchStart: function() {
                ...
                for (var page in data.pages) {
                    if (has(page, data.pages) &&
                        turnMethods._eventStart.apply(data.pages[page], arguments) === false) {
                        return false;
                    }
                }
            },
            ...
            _touchMove: function() {
                ...
                for (var page in data.pages) {
                    if (has(page, data.pages)) {
                        turnMethods._eventMove.apply(data.pages[page], arguments);
                    }
                }
            },
            ...
            _touchEnd: function() {
                ...
                for (var page in data.pages) {
                    if (has(page, data.pages)) {
                        turnMethods._eventEnd.apply(data.pages[page], arguments);
                    }
                }
            },
            ...
            _resizeViewport: function() {
                ...
                if (options.zoom == 1) {
                    ...
                    if (bound.width != this.width() || bound.height != this.height()) {
                        this.turn('size', this.parent().width() * 0.9, bound.height * 0.9);
                    }
                }
            ...
            init: function(opts) {
                ...
                turnMethods._addPageWrapper.call(this);
            ...
            _cornerActivated: function(p) {
                ...
                var allowedCorners = turnMethods._cAllowed.call(this);
            ...
            _isIArea: function(e) {
                ...
                return turnMethods._cornerActivated.call(this, {
                    x: e.pageX - pos.left,
                    y: e.pageY - pos.top
                });
                ...
                switch (data.effect) {
                    ...
                    case 'sheet':
                        ...
                        if (full) {
                            ...
                            if (turnMethods._backGradient.call(this))
                                data.bshadow.css({
                                    width: width,
                                    height: height
                                });
                ...
                if (!data.wrapper)
                    switch (data.effect) {
                        ...
                        case 'sheet':
                            ...
                            turnMethods.setData.call(this, data);

                            break;
                    }

                // Set size
                turnMethods.resize.call(this, true);
            ...
            _fold: function(point) {
                ...
                var data = this.data().f,
                    turnData = data.opts.turn.data(),
                    o = turnMethods._c.call(this, point.corner),
                    width = this.width(),
                    height = this.height();
                ...
                switch (data.effect) {
                    ...
                    case 'sheet':
                        ...
                        var that = this,
                            ...
                            df = point2D(0, 0),
                            tr = point2D(0, 0),
                            folding = turnMethods._foldingPage.call(this),
                            tan = Math.tan(alpha),
                            ...
                            compute = function() {
                                ...
                                if (turnData.opts.gradients) {
                                    ...
                                    var endingPoint = turnMethods._c2.call(that, point.corner),
                                    ...
                                    if (turnMethods._backGradient.call(that)) {
            ...
            _moveFoldingPage: function(move) {
                ...
                if (move) {
                    ...
                    if (place[nextPage] != data.opts.page) {
                        ...
                        if (data.folding)
                            turnMethods._moveFoldingPage.call(this, false);

                        var folding = turnMethods._foldingPage.call(this);
                ...
                if (folding) {
                    ...
                    if (animate) {
                        ...
                        var that = this,
                            ...
                            data.point : turnMethods._c.call(this, c.corner, 1);
                        ...
                        this.animatef({
                            ...
                            frame: function(v) {
                                c.x = Math.round(v[0]);
                                c.y = Math.round(v[1]);
                                turnMethods._fold.call(that, c);
                            }
                        });

                    } else {

                        turnMethods._fold.call(this, c);
                    ...
                    if (!visible) {
                        ...
                        switch (data.effect) {
                            case 'hard':
                                ...
                                data.visible = true;
                                turnMethods._moveFoldingPage.call(this, true);
                                data.fpage.show();
            ...
            hideFoldedPage: function(animate) {
                ...
                if (animate) {
                    ...
                    var p4 = turnMethods._c.call(this, p1.corner),
                    ...
                    this.animatef({
                        ...
                        frame: function(v) {
                            ...
                            p1.x = np.x;
                            p1.y = np.y;
                            turnMethods._fold.call(that, p1);
                        },
                        complete: hide,
                        duration: 800,
                        hiding: true
            ...
            turnPage: function(corner) {
                ...
                corner = {
                    corner: (data.corner) ?
                        data.corner.corner : corner || turnMethods._cAllowed.call(this)[0]
                };

                var p1 = data.point ||
                    turnMethods._c.call(this,
                        corner.corner,
                        (data.opts.turn) ? turnData.opts.elevation : 0),
                    p4 = turnMethods._c2.call(this, corner.corner);
                ...
                this.trigger('flip').animatef({
                    ...
                    frame: function(v) {
                        ...
                        corner.x = np.x;
                        corner.y = np.y;
                        turnMethods._showFoldedPage.call(that, corner);
            ...
            _eventStart: function(e) {
                ...
                if (!data.corner && !data.disabled && !this.flip('isTurning') &&
                    ...
                    data.corner = turnMethods._isIArea.call(this, e);

                    if (data.corner && turnMethods._foldingPage.call(this)) {

                        this.trigger('pressed', [data.point]);
                        turnMethods._showFoldedPage.call(this, data.corner);
            ...
            _eventMove: function(e) {
                ...
                if (!data.disabled) {
                    ...
                    if (data.corner) {
                        ...
                        var point = turnMethods._isIArea.call(this, e[0]);

                        if (point) {

                            if ((data.effect == 'sheet' && point.corner.length == 2) || data.effect == 'hard') {
                                data.status = 'hover';
                                var origin = turnMethods._c.call(this, point.corner, data.opts.cornerSize / 2);
                                point.x = origin.x;
                                point.y = origin.y;
                                turnMethods._showFoldedPage.call(this, point, true);
                            }
                            ...
                            if (data.status == 'hover') {
                                data.status = '';
                                turnMethods.hideFoldedPage.call(this, true);
                            }
            ...
            peel: function(corner, animate) {
                ...
                if (corner) {
                    ...
                    if ($.inArray(corner, turnMethods._cAllowed.call(this)) != -1) {

                        var point = turnMethods._c.call(this, corner, data.opts.cornerSize / 2);

                        data.status = 'peel';

                        turnMethods._showFoldedPage.call(this, {
                            corner: corner,
                            x: point.x,
                            y: point.y
                        }, animate);
                    ...
                    turnMethods.hideFoldedPage.call(this, animate);
